...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.H6(children='South Dakota Cases',
                    style={
                        'textAlign': 'center',
                        'color': 'white'}
                    ),
        ...
        html.Div([
            html.H6(children='South Dakota Deaths',
                    style={
                        'textAlign': 'center',
                        'color': 'white'}
                    ),
        ...
        html.Div([
            html.H6(children='South Dakota Recovered',
                    style={
                        'textAlign': 'center',
                        'color': 'white'}
                    ),
        ...
        html.Div([
            html.H6(children='South Dakota Active',
                    style={
                        'textAlign': 'center',
                        'color': 'white'}
                    ),
...
# daily confirmed
    ...
    return {
        'data': [go.Bar(x=covid_data_3[covid_data_3['Country/Region'] == w_countries]['date'].tail(30),
                        ...
                        '<b>County</b>: ' + covid_data_3[covid_data_3['Country/Region'] == w_countries]['Country/Region'].tail(30).astype(str) + '<br>'
...
def update_graph(w_countries):
    ...
    return {
        'data': [go.Scattermapbox(
                         ...
                         hoverinfo='text',
                         hovertext=
                         '<b>County</b>: ' + covid_data_4['Country/Region'].astype(str) + '<br>' +
