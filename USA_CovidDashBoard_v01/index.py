...
url_recovered = 'time_series_covid19_recovered_US.csv'
...
# daily confirmed
    ...
    return {
        'data': [go.Bar(x=covid_data_3[covid_data_3['Country/Region'] == w_countries]['date'].tail(30),
                        ...
                        '<b>State</b>: ' + covid_data_3[covid_data_3['Country/Region'] == w_countries]['Country/Region'].tail(30).astype(str) + '<br>'
...
def update_graph(w_countries):
    ...
    return {
        'data': [go.Scattermapbox(
                         ...
                         hoverinfo='text',
                         hovertext=
                         '<b>State</b>: ' + covid_data_4['Country/Region'].astype(str) + '<br>' +
